...
import { Input, FormCont, Label, SubmitButton, Text, ErrorText } from './ContactForm.styled';
...
const schema = Yup.object().shape({
   name: Yup.string().required().min(5).max(24).matches("^[a-zA-Zа-яА-Я]+(([' -][a-zA-Zа-яА-Я ])?[a-zA-Zа-яА-Я]*)*$", "Please enter correct name" ),
